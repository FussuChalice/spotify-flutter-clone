...
//
//     final userSavedTracks = userSavedTracksFromJson(jsonString);

import 'dart:convert';

UserSavedTracks userSavedTracksFromJson(String str) => UserSavedTracks.fromJson(json.decode(str));

String userSavedTracksToJson(UserSavedTracks data) => json.encode(data.toJson());
...
class UserSavedTracks {
    ...
    factory UserSavedTracks.fromJson(Map<String, dynamic> json) => UserSavedTracks(
        href: json["href"],
        limit: json["limit"],
        next: json["next"],
        offset: json["offset"],
